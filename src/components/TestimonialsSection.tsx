...
const TestimonialsSection = () => {
  ...
  return (
    <section className="py-20 bg-rose-25 bg-gradient-to-r from-rose-50 to-blue-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-slate-800 mb-6">O que nossas clientes dizem</h2>
            ...
            <Card key={index} className="bg-white border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-6">
                <div className="flex justify-between items-start mb-4">
                  <Quote className="text-rose-300" size={24} />
                ...
                <div className="border-t pt-4">
                  ...
                  <p className="text-sm text-rose-500 mt-1">{testimonial.treatment}</p>
                </div>
              </CardContent>
            </Card>
          ))}
        ...
        <div className="text-center mt-12">
          <div className="inline-flex items-center gap-2 bg-white px-6 py-3 rounded-full shadow-md">
            ...
            <span className="text-slate-700 font-semibold">4.9/5 baseado em 127 avaliações</span>
          </div>
        </div>
      </div>
    </section>
